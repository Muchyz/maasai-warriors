...
const SERVICES = [
  ...
  { icon: Users, title: "Cultural Tours", desc: "Step into authentic Maasai village life — dances, traditions, beadwork, and stories passed down generations.", img: "https://images.unsplash.com/photo-1489392191049-fc10c97e64b6?w=700&q=80" },
...
const DESTINATIONS = [
  { name: "Hell's Gate NP", tag: "Gilgil Doorstep", desc: "Dramatic gorges, geothermal activity, and zebras you can cycle past. 30 minutes from our base.", img: "https://images.unsplash.com/photo-1567522804-d77e621a1a01?w=700&q=80", hours: "45 min drive" },
...
const TEAM = [
  { name: "Joshua Lekoolal", role: "Lead Safari Guide & Founder", img: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=500&q=80", bio: "Born and raised in the Maasai Mara, Joshua has 15+ years guiding Big Five safaris and speaks English, Swahili, and Maa.", tags: ["KPSGA Licensed", "15+ Years", "EN · SW · Maa"] },
      ...
      <section className="section director-sec">
        <div className="director-grid">
          <div className="director-img-wrap">
            <img className="director-img" src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=700&q=85" alt="Founder & Director" />
